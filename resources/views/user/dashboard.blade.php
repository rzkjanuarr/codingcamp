                    ...
                    <tbody>
                        @forelse ($checkouts as $checkout)
                            <tr class="align-middle">
                                ...
                                <td>
                                    <a href="https://wa.me/085749463854?text=Hi, Halo, Saya ingin bertanya mengenai kelas yang ada di CodingCamp ID. {{$checkout->Camp->title}}" target="_blank" class="btn btn-primary">
                                        Contact Support
                                    </a>
                                </td>
                            </tr>
